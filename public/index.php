...
?>
    ...
    <div class="lead mt-5 text-left">
        <p>В инфоблоке с закладками должны быть созданы свойства типа «строка»: META_TITLE, META_DESCRIPTION, META_KEYWORDS.</p>
        <p>Можно настроить Sphinx на сервере и переключить затем в настройках модуля тип поиска, сейчас стоит по умолчанию. Хорошая статья по теме:
